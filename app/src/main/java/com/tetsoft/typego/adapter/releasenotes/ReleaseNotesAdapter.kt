package com.tetsoft.typego.adapter.releasenotes
...
import com.tetsoft.typego.data.ReleaseNote
...
class ReleaseNotesAdapter(private val context: Context, private val releaseNotes: List<ReleaseNote>) : RecyclerView.Adapter<ReleaseNotesAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ReleaseNotesAdapter.ViewHolder {
